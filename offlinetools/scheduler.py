...
class PullObject(object):
    ...
    def _update(self, data, expect_second_update):
        ...
        publication_views = [self._insert_publication_views, self._delete_publication_views]
        ...
        fieldgroup_fields = [self._insert_fieldgroup_fields, self._delete_fieldgroup_fields]
        users = [self._delete_users, self._update_users, self._insert_users]
        records = [self._insert_records]
        record_views = [self._insert_record_views, self._delete_record_views]
        records_communities = [self._insert_records_communities, self._delete_records_communities]
        records_publications = [self._insert_records_publications, self._delete_records_publications]
