...
Name: "{group}\Outils déconnecté"; Filename: http://localhost:8765/?Ln=fr-CA; Languages: french; 
...
begin
  if CurStep=ssPostInstall then
     SetFirewallException('CIOC Offline Tools', ExpandConstant('{app}')+'\wsgisvc.exe');
end;

procedure CurUninstallStepChanged(CurUninstallStep: TUninstallStep);
begin
  if CurUninstallStep=usPostUninstall then
     RemoveFirewallException(ExpandConstant('{app}')+'\wsgisvc.exe');
end;
